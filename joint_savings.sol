/*
Joint Savings Account- Assignment Jan 24, 2024
---------------------
...
contract JointSavings {
    ...
    */
    function withdraw(uint amount, address payable recipient) public {
        ...
        */
        ...
        ///had error: require(address(this).contractBalance >= amount, "Insufficient funds!");
        /*
        ...
        */
        ...
        // YOUR CODE HERE!
        recipient.transfer(amount);
        ///accountBalance = address(this).accountBalance;
    ...
    */
    function setAccounts(address payable account1, address payable account2) public{
        ...
        // YOUR CODE HERE!
        setAccounts(accountOne, account1);
        setAccounts(accountTwo, account2); 
    }
